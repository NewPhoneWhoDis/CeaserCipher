...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter an offset to decipher the message!");
        System.out.println("Following message is deciphered: " + caesarCipher.decipher(result, userInput.nextInt()));
    }
